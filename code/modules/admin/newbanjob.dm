...
/proc/AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, rank)
	...
	if(rank == "Heads")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Seneschal")
		...
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Magos")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Research Director")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Sister Hospitaller")
		return 1
	if(rank == "Security")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Commissar")
