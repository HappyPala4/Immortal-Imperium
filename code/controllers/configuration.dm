...
/datum/configuration
	...
	var/vote_delay = 96000				// minimum time between voting sessions (deciseconds, 90 minutes by default)
	var/vote_period = 900				// length of voting period (deciseconds, default 1 minute)
	var/vote_autotransfer_initial = 108000 // Length of time before the first autotransfer vote is called
	var/vote_autotransfer_interval = 26000 // length of time before next sequential autotransfer vote
...
//	var/enable_authentication = 0		// goon authentication
	...
	var/protect_roles_from_antagonist = 0// If security and such can be heretic/cult/other
