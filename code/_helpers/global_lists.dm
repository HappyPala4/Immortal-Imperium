...
var/global/list/whitelisted_species = list() // Species that require a whitelist check. Left empty so no role/species needs a whitelist.
var/global/list/playable_species = list(SPECIES_HUMAN, SPECIES_ASTARTES, SPECIES_ELDAR, SPECIES_SCOUT)    // A list of ALL playable species, whitelisted, latejoin or otherwise.
