...
var/list/ANTAG_FREQS = list(RED_ALPHA, RED_BRAVO, RED_CHARLIE, RED_DELTA, BLUE_FREQ, BLUE_ALPHA, BLUE_BRAVO, BLUE_CHARLIE, BLUE_DELTA, HIVE_FREQ, RED_INQ)
...
var/list/DEPT_FREQS = list(RED_FREQ, AI_FREQ, COMM_FREQ, ENG_FREQ, MED_FREQ, MAG_FREQ, INQ_FREQ, SEC_FREQ, SCI_FREQ, SRV_FREQ, SUP_FREQ, EXP_FREQ, ENT_FREQ)
