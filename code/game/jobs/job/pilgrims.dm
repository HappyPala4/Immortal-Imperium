 ...
 //skills are between 1-5 for roles that have little to no reason to know something, 5-10 if they are able to naturally learn those skills, 5 is baseline,
	switch(classchoice)
		...
		if("Messian Tribal")
			...
			equip_to_slot_if_possible(new /obj/item/glass_jar, slot_in_backpack)
			...
			equip_to_slot_if_possible(new /obj/item/paper/administratum, slot_in_backpack)
			...
			if(prob(15))
				...
				deity.add_cultist(U)
				if(prob(2))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_eng, slot_in_backpack)
				if(prob(3))
				...
				if(prob(5))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/blue_team/all, slot_in_backpack)
			else if(prob(35))
				...
				if(prob(40))
					equip_to_slot_if_possible(new /obj/item/gun/projectile/shotgun/pump/boltaction/shitty/glory, slot_in_backpack)
				else
					equip_to_slot_if_possible(new /obj/item/gun/projectile/thrower, slot_in_backpack)
					equip_to_slot_if_possible(new /obj/item/storage/box/sniperammo/apds/bos, slot_in_backpack)
					equip_to_slot_if_possible(new /obj/item/storage/box/sniperammo/apds/bos, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/ammo_magazine/handful/brifle_handful/ms, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/ammo_magazine/handful/brifle_handful, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/sherpa, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/reagent_containers/food/snacks/threebread, slot_in_backpack)
		...
		if("Nomad")
			...
			if(prob(15))
				...
				equip_to_slot_if_possible(new /obj/item/melee/trench_axe/bardiche/beast, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/reagent_containers/food/snacks/threebread, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/melee/sword/combat_knife/bowie, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/bonearmor, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/dragon, slot_head)
			else
				...
				if(prob(30))
					equip_to_slot_if_possible(new /obj/item/gun/energy/las/lasgun/shitty, slot_in_backpack)
				else if(prob(30))
					equip_to_slot_if_possible(new /obj/item/gun/energy/pulse/pulsepistol, slot_in_backpack)
				else if(prob(10))
					equip_to_slot_if_possible(new /obj/item/gun/energy/pulse/plasma/pistol/glock, slot_in_backpack)
				else
					equip_to_slot_if_possible(new /obj/item/gun/energy/las/triplex, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/ranger2, slot_wear_suit)
		...
		if("Scum") // Pariah story. The magical 357
			...
			equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_sci, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/card/id/pilgrim/penitent, slot_wear_id)
			equip_to_slot_if_possible(new /obj/item/torch/self_lit, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/storage/backpack/satchel/warfare, slot_back)
			U.verbs -= list(/mob/living/carbon/human/proc/penitentclass,)
			U.stat = CONSCIOUS
			U.sleeping = 0
			...
			if(prob(35))
				...
				if(prob(50))
					...
					equip_to_slot_if_possible(new /obj/item/clothing/under/rank/victorian/blred, slot_w_uniform)
				else
					equip_to_slot_if_possible(new /obj/item/clothing/under/rank/victorian/redbl, slot_w_uniform)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/scum, slot_wear_suit)
				...
				equip_to_slot_if_possible(new /obj/item/device/flashlight/lantern, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/reagent_containers/food/snacks/threebread, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon3, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
				var/datum/heretic_deity/deity = GOD(U.client.prefs.cult)
				deity.add_cultist(U)
				if(prob(5))
				...
				equip_to_slot_if_possible(new /obj/item/gun/projectile/slugrevolver/penitent, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/ammo_magazine/c44, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/ammo_magazine/c44, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/raggedrobe, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/clothing/head/plebhood, slot_head)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon3, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
				if(prob(25))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_sci, slot_in_backpack)
		if("Witch Hunter")
			...
			equip_to_slot_if_possible(new /obj/item/melee/sword/cane, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/witch, slot_head)
			equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/witch, slot_wear_suit)
			equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_sci, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon4, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/paper/administratum/theta, slot_in_backpack)
		if("Mercenary")
			...
			if(prob(25))
				...
				equip_to_slot_if_possible(new /obj/item/melee/trench_axe/glaive/adamantine, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/brigandine, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/hero, slot_head)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon3, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/theta, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
				var/datum/heretic_deity/deity = GOD(U.client.prefs.cult)
				...
				equip_to_slot_if_possible(new /obj/item/paper/administratum/theta, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/armoredtrench, slot_wear_suit)
				if(prob(2))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_eng, slot_in_backpack)
				if(prob(2))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/red_team, slot_in_backpack)
				...
				equip_to_slot_if_possible(new /obj/item/gun/projectile/revolver/mateba, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/ammo_magazine/c50, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/ammo_magazine/c50, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon4, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/theta, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
				if(prob(60))
					equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/bountyhunter2, slot_wear_suit)
					equip_to_slot_if_possible(new /obj/item/clothing/head/bountyhead, slot_head)
				else if(prob(50))
					equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/carapace3, slot_wear_suit)
					equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/marinehelm, slot_head)
				else if(prob(30))
					equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/vanpa, slot_wear_suit)
				else
					equip_to_slot_if_possible(new /obj/item/ammo_magazine/c50, slot_in_backpack)
				if(prob(15))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/red_team, slot_in_backpack)
					equip_to_slot_if_possible(new /obj/item/card/id/key/middle/jail, slot_in_backpack)
				if(prob(3))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_sci, slot_in_backpack)
					equip_to_slot_if_possible(new /obj/item/card/id/key/grand/monastary, slot_in_backpack)
	...
	switch(classchoice)
		...
		if("Mysterious Citizen")
			...
			if(prob(10))
				...
				equip_to_slot_if_possible(new /obj/item/storage/firstaid/surgery)
				equip_to_slot_if_possible(new /obj/item/clothing/mask/gas/prac_mask)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/prac_arpon, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/clothing/gloves/prac_gloves)
				equip_to_slot_if_possible(new /obj/item/clothing/shoes/prac_boots, slot_shoes)
				equip_to_slot_if_possible(new /obj/item/toothpuller, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/card/id/ring/disgracedmedicae, slot_wear_id)
				equip_to_slot_if_possible(/obj/item/reagent_containers/food/snacks/warfare/rat, slot_in_backpack)
				if(prob(5))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/blue_team/all, slot_in_backpack)
				var/datum/heretic_deity/deity = GOD(U.client.prefs.cult)
				deity.add_cultist(U)
				...
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/slumcoat, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/storage/box/syndie_kit/imp_freedom, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/head/chameleon, slot_head)
				equip_to_slot_if_possible(new /obj/item/clothing/under/chameleon, slot_in_backpack)
				var/datum/heretic_deity/deity = GOD(U.client.prefs.cult)
				deity.add_cultist(U)
				if(prob(1))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_eng, slot_in_backpack)
				...
				equip_to_slot_if_possible(new /obj/item/ammo_magazine/a357/ms, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/storage/briefcase/crimekit)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/bountyhunter2, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/tduster, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/head/det, slot_head)
				equip_to_slot_if_possible(new /obj/item/storage/fancy/cigarettes/dromedaryco, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/flame/lighter, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/under/det/black, slot_w_uniform)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon3, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/theta, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
		if("Miner")
			...
			equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/hard_had, slot_head)
			equip_to_slot_if_possible(new /obj/item/clothing/under/rank/victorian, slot_w_uniform)
			equip_to_slot_if_possible(new /obj/item/storage/backpack/satchel/satchel_eng, slot_back)
			equip_to_slot_if_possible(new /obj/item/pickaxe/mechanicus, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/clothing/suit/miner, slot_wear_suit)
			equip_to_slot_if_possible(new /obj/item/clothing/shoes/prac_boots, slot_shoes)
			equip_to_slot_if_possible(new /obj/item/device/flashlight/lantern, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/card/id/ring/disgracedmedicae, slot_wear_id)
			equip_to_slot_if_possible(new /obj/item/stack/thrones3/twenty, slot_in_backpack)
		...
		if("Honour Guard")
			...
			equip_to_slot_if_possible(new /obj/item/card/id/key/grand/monastary, slot_wear_id)
			equip_to_slot_if_possible(new /obj/item/stack/thrones/five, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/hevhelm/palace, slot_head)
		...
		if("PDF")
			...
			equip_to_slot_if_possible(new /obj/item/clothing/gloves/thick, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/clothing/mask/gas/half/cadianrespirator, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/clothing/under/cadian_uniform, slot_w_uniform)
			equip_to_slot_if_possible(new /obj/item/storage/backpack/satchel/warfare, slot_back)
			if(prob(25))
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/whiteshield/pdf, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/whiteshield/pdf, slot_head)
				equip_to_slot_if_possible(new /obj/item/gun/projectile/automatic/heavystubber, slot_in_backpack)
			if(prob(35))
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/whiteshield/pdf/medic, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/storage/belt/medical/full, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/whiteshield/pdf/medic, slot_head)
			else
				equip_to_slot_if_possible(new /obj/item/clothing/suit/armor/whiteshield/pdf/spec, slot_wear_suit)
				equip_to_slot_if_possible(new /obj/item/clothing/head/helmet/whiteshield/pdf/spec, slot_head)
				equip_to_slot_if_possible(new /obj/item/cell/plasma, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/clothing/shoes/jackboots/cadian, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/device/flashlight/lantern, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon3, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/paper/administratum/theta, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/card/id/dog_tag/guardsman, slot_wear_id)
			equip_to_slot_if_possible(new /obj/item/device/radio/headset/red_team, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/cell/lasgun, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/cell/lasgun, slot_in_backpack)
		...
		if("Disgraced Noble")
			...
			if(prob(15))
				...
				equip_to_slot_if_possible(new /obj/item/clothing/head/culthood/magus, slot_head)
				equip_to_slot_if_possible(new /obj/item/clothing/suit/cultrobes/magusred, slot_wear_suit)
				if(prob(10))
					equip_to_slot_if_possible(new /obj/item/device/radio/headset/blue_team/all, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/reagent_containers/food/snacks/warfare/rat, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/reagent_containers/glass/bottle/spice, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/reagent_containers/glass/bottle/spice, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
				var/datum/heretic_deity/deity = GOD(U.client.prefs.cult)
				deity.add_cultist(U)
				...
				equip_to_slot_if_possible(new /obj/item/instrument/guitar, slot_l_hand)
				equip_to_slot_if_possible(new /obj/item/device/violin, slot_r_hand)
				equip_to_slot_if_possible(new /obj/item/paper/administratum/weapon3, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/pen, slot_in_backpack)
				equip_to_slot_if_possible(new /obj/item/reagent_containers/food/snacks/warfare/rat, slot_in_backpack)
		if("Fate Touched")
			...
			equip_to_slot_if_possible(new /obj/item/storage/backpack/satchel/warfare, slot_back)
			equip_to_slot_if_possible(new /obj/item/device/radio/headset/headset_sci, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/book/manual, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/card/id/pilgrim/penitent, slot_wear_id)
			equip_to_slot_if_possible(new /obj/item/device/flashlight/lantern, slot_in_backpack)
			equip_to_slot_if_possible(new /obj/item/clothing/shoes/jackboots/pilgrim_boots, slot_shoes)
			U.verbs -= list(/mob/living/carbon/human/proc/citizenclass,)
...
/mob/living/carbon/human/proc/gangerclass()
	...
	var/fates = list("Bruiser","Assassin",)
